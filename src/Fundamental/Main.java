...
class Shop {
	...
	/*
	 * Method to initializing products in the shop
	 * 
	...
	/*
	 * Method to get product details from product list by ID
	 * 
	...
	/*
	 * Method to get product details from cart by ID
	 * 
	 * @return Product object
	 */
	...
	/*
	 * Method to display product in the store
	 */
	private void displayStoreProducts() {
		...
		for (Product prod : products) {
			System.out.printf("%5d %20s %10.2f %10d \n", prod.getPid(),
					prod.getName(), prod.getPrice(), prod.getStock());
		}
	}

	/*
	 * Method to add item cart
	 */
	public void addProductToCart() {
		...
		if (prod == null) {
			...
			System.out
					.println("Already present in the cart. Want to change quantity?");
	...
	/*
	 * Method to display items of the cart
	 */
	private void showCart() {
		...
		for (Product prod : cartItems) {
			System.out.printf("%5d %5d %20s %10d %10.2f \n", ++i,
					prod.getPid(), prod.getName(), prod.getStock(),
	...
	private void Bill() {
		...
		for (Product prod : cartItems) {
			System.out.printf("%5d %5d %20s %15.2f %10d %15.2f \n", ++i,
					prod.getPid(), prod.getName(), prod.getPrice(),
					prod.getStock(), prod.getPrice() * prod.getStock());
