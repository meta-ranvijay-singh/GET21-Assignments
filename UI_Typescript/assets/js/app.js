...
const vehicle_ident_input = document.querySelector("#enter_vehicle_identification");
...
vehicle_ident_input.addEventListener("keypress", (e) => {
    if (e.key === "Enter") {
        ...
        if (vehicle.identification != "") {
            document.querySelector("#vehicle_identification").innerHTML = vehicle.identification;
            document
